...
#LOCAL
cat_pics = Dir.entries("app/assets/images/catpictures")
...
35.times do |x| 
    ...
    Media.last.picture.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'cats', cat_pic)), filename: cat_pic[x], content_type: 'image/jpg')
end
