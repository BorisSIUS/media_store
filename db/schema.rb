...
ActiveRecord::Schema.define(version: 2020_09_01_170715) do
  ...
  create_table "order_media_relations", force: :cascade do |t|
    t.bigint "order_id"
    t.bigint "media_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["media_id"], name: "index_order_media_relations_on_media_id"
    t.index ["order_id"], name: "index_order_media_relations_on_order_id"
  end
